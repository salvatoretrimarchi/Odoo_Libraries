    ...
    def process_payment(self):
        ...
        for res in result:
            ...
            for inv_line in res.get('values'):
                ...
                paid_amount = (inv_line.get('paid_amount') / 2)

                if invoice.residual == paid_amount:
                    full_reco = True
            ...
            payment_id2 = self.env['account.payment'].create(pay_val2)
            ...
            for inv_line in res.get('values'):
                ...
                paid_amt2 += paid_amount

            payment_id2.write({
                'line_ids': line_list2,
                'amount': paid_amt2,
                'invoice_ids': [(6, 0, inv_ids2)]
            })
